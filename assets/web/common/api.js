...
ifly_putString = function(sharedPreferanceName,key,value) {
	return exec('com.iflytek.mmp.components.database.SharedPreferencesComponents', 'putString', [sharedPreferanceName,key,value]);
};
ifly_getString = function(sharedPreferanceName,key){
	var result=exec('com.iflytek.mmp.components.database.SharedPreferencesComponents', 'getString', [sharedPreferanceName,key]);
