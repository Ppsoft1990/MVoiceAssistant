...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lec;->k:Ljava/lang/String;
    ...
    sput-object v0, Lec;->l:Ljava/lang/String;
...
.method private constructor <init>()V
    ...
    iput-object v3, p0, Lec;->b:Ljava/lang/String;

    iput-boolean v2, p0, Lec;->c:Z

    iput-boolean v2, p0, Lec;->d:Z

    iput-wide v0, p0, Lec;->e:D

    iput-wide v0, p0, Lec;->f:D

    iput-wide v0, p0, Lec;->g:D

    iput-wide v0, p0, Lec;->h:D

    iput-wide v0, p0, Lec;->i:D

    iput-boolean v2, p0, Lec;->j:Z

    new-instance v0, Landroid/os/Handler;

    invoke-direct {v0}, Landroid/os/Handler;-><init>()V

    iput-object v0, p0, Lec;->m:Landroid/os/Handler;

    :try_start_0
    new-instance v0, Ljava/io/File;

    sget-object v1, Lec;->k:Ljava/lang/String;

    invoke-direct {v0, v1}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    new-instance v1, Ljava/io/File;

    sget-object v2, Lec;->l:Ljava/lang/String;
...
.method static synthetic a(Lec;Z)Ljava/lang/String;
    .locals 1

    invoke-direct {p0, p1}, Lec;->b(Z)Ljava/lang/String;
...
.method static synthetic a(Lec;)V
    .locals 0
...
.method static synthetic a(Lec;Lfu;Lcom/baidu/location/BDLocation;Landroid/database/sqlite/SQLiteDatabase;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lec;->a(Lfu;Lcom/baidu/location/BDLocation;Landroid/database/sqlite/SQLiteDatabase;)V

    return-void
.end method

.method static synthetic a(Lec;Ljava/lang/String;Lfw;Landroid/database/sqlite/SQLiteDatabase;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lec;->a(Ljava/lang/String;Lfw;Landroid/database/sqlite/SQLiteDatabase;)V

    return-void
.end method

.method static synthetic a(Lec;Ljava/lang/String;Ljava/util/List;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lec;->a(Ljava/lang/String;Ljava/util/List;)V

    return-void
.end method

.method private a(Lfu;Lcom/baidu/location/BDLocation;Landroid/database/sqlite/SQLiteDatabase;)V
    .locals 20

    if-eqz p2, :cond_0

    invoke-virtual/range {p2 .. p2}, Lcom/baidu/location/BDLocation;->f()I
    ...
    invoke-virtual/range {p2 .. p2}, Lcom/baidu/location/BDLocation;->p()Ljava/lang/String;
    ...
    iget-object v3, v0, Lfu;->a:Ljava/util/List;
...
.method private a(Ljava/lang/String;Lfw;Landroid/database/sqlite/SQLiteDatabase;)V
    .locals 10
    ...
    invoke-virtual {p2}, Lfw;->h()Ljava/lang/String;
...
.method private a(Ljava/lang/String;Ljava/util/List;)V
    ...
    sget-object v0, Lec;->l:Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v0}, Lec;->a(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    :cond_0
    invoke-direct {p0, p2, v0}, Lec;->a(Ljava/util/List;Landroid/database/sqlite/SQLiteDatabase;)V
...
.method private a(Ljava/util/List;Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    iget-wide v6, v0, Lec;->g:D

    move-object/from16 v0, p0

    iget-wide v8, v0, Lec;->f:D
...
.method private b(Z)Ljava/lang/String;
    ...
    iget-wide v8, p0, Lec;->h:D

    iget-wide v6, p0, Lec;->i:D
    ...
    iget-wide v8, p0, Lec;->f:D

    iget-wide v6, p0, Lec;->g:D

    iget-wide v4, p0, Lec;->e:D

    invoke-static {}, Lfc;->b()Lfc;

    move-result-object v0

    invoke-virtual {v0}, Lfc;->g()Z
...
.method static synthetic b(Lec;Z)Z
    .locals 0
...
.method private d()V
    ...
    :try_start_0
    sget-object v3, Lec;->l:Ljava/lang/String;
    ...
    invoke-direct {v1, p0, v4}, Lec$a;-><init>(Lec;Led;)V
    ...
    invoke-virtual {v1, v4}, Lec$a;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method public a(Ljava/lang/String;Ljava/util/List;Z)Lcom/baidu/location/BDLocation;
    ...
    invoke-direct {v2, p0, p1, p2}, Lee;-><init>(Lec;Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-virtual {v3, v6}, Ldy;->a(Ljava/lang/String;)V
...
.method public a(Z)Lcom/baidu/location/BDLocation;
    ...
    invoke-virtual {v1}, Lfw;->h()Ljava/lang/String;
    ...
    iget-object v3, v2, Lfu;->a:Ljava/util/List;

    invoke-virtual {p0, v0, v3, v11}, Lec;->a(Ljava/lang/String;Ljava/util/List;Z)Lcom/baidu/location/BDLocation;
    ...
    invoke-virtual {v2, v4}, Lfu;->c(I)Ljava/lang/String;
    ...
    :cond_2
    const-string/jumbo v1, "&uptype=oldoff"
    ...
    invoke-virtual {v1, v10}, Ldj;->a(Z)Ljava/lang/String;
    ...
    sget-object v2, Ldy;->a:Ljava/lang/String;

    invoke-static {v1}, Lcom/baidu/location/Jni;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-static {v2, v1}, Ldy;->a(Ljava/lang/String;Ljava/lang/String;)V

    :cond_3
    return-object v0
.end method

.method public a(Ljava/lang/String;Lfw;Lfu;Lcom/baidu/location/BDLocation;)V
    .locals 5
    ...
    invoke-virtual {p4}, Lcom/baidu/location/BDLocation;->f()I
    ...
    invoke-virtual {p4}, Lcom/baidu/location/BDLocation;->p()Ljava/lang/String;
    ...
    :goto_1
    iget-object v4, p3, Lfu;->a:Ljava/util/List;
    ...
    invoke-direct {v0, p0, v3}, Lec$b;-><init>(Lec;Led;)V
    ...
    invoke-virtual {v0, v3}, Lec$b;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method public b()V
    ...
    iget-object v0, p0, Lec;->m:Landroid/os/Handler;
