...
.field private final h:Landroid/support/v4/widget/DrawerLayout$d;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->e:Landroid/graphics/Paint;
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/DrawerLayout$d;
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/DrawerLayout$d;

    .line 234
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/DrawerLayout$d;

    invoke-static {p0, v5, v2}, Lcc;->a(Landroid/view/ViewGroup;FLcc$a;)Lcc;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->f:Lcc;

    .line 235
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->f:Lcc;

    invoke-virtual {v2, v4}, Lcc;->a(I)V

    .line 236
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->f:Lcc;

    invoke-virtual {v2, v1}, Lcc;->a(F)V

    .line 237
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/DrawerLayout$d;

    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->f:Lcc;

    invoke-virtual {v2, v3}, Landroid/support/v4/widget/DrawerLayout$d;->a(Lcc;)V

    .line 239
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/DrawerLayout$d;

    invoke-static {p0, v5, v2}, Lcc;->a(Landroid/view/ViewGroup;FLcc$a;)Lcc;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->g:Lcc;

    .line 240
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->g:Lcc;

    const/4 v3, 0x2

    invoke-virtual {v2, v3}, Lcc;->a(I)V
    ...
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->g:Lcc;
    ...
    invoke-static {p0, v2}, Lbe;->a(Landroid/view/View;Laq;)V

    .line 248
    const/4 v2, 0x0

    invoke-static {p0, v2}, Lbn;->a(Landroid/view/ViewGroup;Z)V
...
.method private e()Z
    ...
    iget-boolean v3, v2, Landroid/support/v4/widget/DrawerLayout$c;->c:Z
    ...
    .line 1159
    .restart local v2    # "lp":Landroid/support/v4/widget/DrawerLayout$c;
    :cond_0
...
.method public a(Landroid/view/View;)I
    ...
    .line 430
    iget v1, p0, Landroid/support/v4/widget/DrawerLayout;->m:I
    ...
    .line 432
    iget v1, p0, Landroid/support/v4/widget/DrawerLayout;->n:I
...
.method a()Landroid/view/View;
    ...
    iget-boolean v3, v3, Landroid/support/v4/widget/DrawerLayout$c;->d:Z
...
.method a(I)Landroid/view/View;
    ...
    .prologue
    .line 558
    invoke-static {p0}, Lbe;->e(Landroid/view/View;)I

    move-result v5

    invoke-static {p1, v5}, Lat;->a(II)I
...
.method public a(II)V
    ...
    invoke-static {p2, v4}, Lat;->a(II)I
    ...
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->f:Lcc;
    ...
    .line 355
    :cond_4
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->g:Lcc;
...
.method a(IILandroid/view/View;)V
    ...
    .line 442
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->f:Lcc;
    ...
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->g:Lcc;
    ...
    .line 456
    .local v1, "lp":Landroid/support/v4/widget/DrawerLayout$c;
    iget v4, v1, Landroid/support/v4/widget/DrawerLayout$c;->b:F
    ...
    .line 463
    .end local v1    # "lp":Landroid/support/v4/widget/DrawerLayout$c;
    :cond_1
    :goto_1
    iget v4, p0, Landroid/support/v4/widget/DrawerLayout;->j:I
    ...
    .line 466
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->q:Landroid/support/v4/widget/DrawerLayout$b;
    ...
    invoke-interface {v4, v3}, Landroid/support/v4/widget/DrawerLayout$b;->a(I)V
    ...
    .line 458
    .restart local v1    # "lp":Landroid/support/v4/widget/DrawerLayout$c;
    :cond_6
    iget v4, v1, Landroid/support/v4/widget/DrawerLayout$c;->b:F
...
.method a(Z)V
    ...
    .line 987
    .local v4, "lp":Landroid/support/v4/widget/DrawerLayout$c;
    invoke-virtual {p0, v0}, Landroid/support/v4/widget/DrawerLayout;->g(Landroid/view/View;)Z
    ...
    iget-boolean v6, v4, Landroid/support/v4/widget/DrawerLayout$c;->c:Z
    ...
    .line 994
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->f:Lcc;
    ...
    invoke-virtual {v6, v0, v7, v8}, Lcc;->a(Landroid/view/View;II)Z
    ...
    iput-boolean v6, v4, Landroid/support/v4/widget/DrawerLayout$c;->c:Z

    goto :goto_1

    .line 997
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->g:Lcc;
    ...
    .end local v4    # "lp":Landroid/support/v4/widget/DrawerLayout$c;
    :cond_3
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/DrawerLayout$d;

    invoke-virtual {v6}, Landroid/support/v4/widget/DrawerLayout$d;->a()V

    .line 1005
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/DrawerLayout$d;
...
.method b(Landroid/view/View;)V
    ...
    iget-boolean v1, v0, Landroid/support/v4/widget/DrawerLayout$c;->d:Z
    ...
    iput-boolean v1, v0, Landroid/support/v4/widget/DrawerLayout$c;->d:Z

    .line 476
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->q:Landroid/support/v4/widget/DrawerLayout$b;
    ...
    invoke-interface {v1, p1}, Landroid/support/v4/widget/DrawerLayout$b;->b(Landroid/view/View;)V
...
.method c()V
    ...
    .line 1209
    iget-boolean v2, p0, Landroid/support/v4/widget/DrawerLayout;->p:Z
...
.method public computeScroll()V
    ...
    iget v2, v4, Landroid/support/v4/widget/DrawerLayout$c;->b:F
    ...
    :cond_0
    iput v3, p0, Landroid/support/v4/widget/DrawerLayout;->d:F

    .line 777
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->f:Lcc;

    invoke-virtual {v4, v6}, Lcc;->a(Z)Z

    move-result v4

    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->g:Lcc;

    invoke-virtual {v5, v6}, Lcc;->a(Z)Z
    ...
    .line 778
    invoke-static {p0}, Lbe;->b(Landroid/view/View;)V
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    invoke-static/range {v25 .. v25}, Landroid/support/v4/widget/DrawerLayout;->k(Landroid/view/View;)Z
    ...
    iget v2, v0, Landroid/support/v4/widget/DrawerLayout;->d:F
    ...
    iget v3, v0, Landroid/support/v4/widget/DrawerLayout;->d:F
    ...
    iget v3, v0, Landroid/support/v4/widget/DrawerLayout;->c:I
    ...
    iget-object v2, v0, Landroid/support/v4/widget/DrawerLayout;->e:Landroid/graphics/Paint;
    ...
    iget-object v7, v0, Landroid/support/v4/widget/DrawerLayout;->e:Landroid/graphics/Paint;
    ...
    iget-object v2, v0, Landroid/support/v4/widget/DrawerLayout;->f:Lcc;

    invoke-virtual {v2}, Lcc;->b()I
    ...
    iget-object v2, v0, Landroid/support/v4/widget/DrawerLayout;->u:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, v0, Landroid/support/v4/widget/DrawerLayout;->g:Lcc;
...
.method e(Landroid/view/View;)I
    ...
    iget v0, v1, Landroid/support/v4/widget/DrawerLayout$c;->a:I
    ...
    invoke-static {v0, v1}, Lat;->a(II)I
...
.method g(Landroid/view/View;)Z
    ...
    iget v1, v2, Landroid/support/v4/widget/DrawerLayout$c;->a:I

    .line 858
    .local v1, "gravity":I
    invoke-static {p1}, Lbe;->e(Landroid/view/View;)I

    move-result v2

    invoke-static {v1, v2}, Lat;->a(II)I
...
.method public h(Landroid/view/View;)V
    ...
    .line 1022
    :cond_0
    iget-boolean v1, p0, Landroid/support/v4/widget/DrawerLayout;->l:Z
    ...
    .line 1034
    .end local v0    # "lp":Landroid/support/v4/widget/DrawerLayout$c;
    :goto_0
    invoke-virtual {p0}, Landroid/support/v4/widget/DrawerLayout;->invalidate()V
    ...
    invoke-virtual {v1, p1, v2, v3}, Lcc;->a(Landroid/view/View;II)Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 865
    invoke-static {p1}, Lay;->a(Landroid/view/MotionEvent;)I

    move-result v0

    .line 868
    .local v0, "action":I
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->f:Lcc;

    invoke-virtual {v7, p1}, Lcc;->a(Landroid/view/MotionEvent;)Z

    move-result v7

    iget-object v8, p0, Landroid/support/v4/widget/DrawerLayout;->g:Lcc;

    invoke-virtual {v8, p1}, Lcc;->a(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v7, p0, Landroid/support/v4/widget/DrawerLayout;->p:Z
    ...
    .line 877
    .local v4, "y":F
    iput v3, p0, Landroid/support/v4/widget/DrawerLayout;->r:F

    .line 878
    iput v4, p0, Landroid/support/v4/widget/DrawerLayout;->s:F

    .line 879
    iget v7, p0, Landroid/support/v4/widget/DrawerLayout;->d:F
    ...
    invoke-virtual {v7, v8, v9}, Lcc;->d(II)Landroid/view/View;
    ...
    .line 883
    :cond_3
    iput-boolean v5, p0, Landroid/support/v4/widget/DrawerLayout;->o:Z

    .line 884
    iput-boolean v5, p0, Landroid/support/v4/widget/DrawerLayout;->p:Z
    ...
    invoke-virtual {v7, v8}, Lcc;->d(I)Z
    ...
    .line 891
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/DrawerLayout$d;

    invoke-virtual {v7}, Landroid/support/v4/widget/DrawerLayout$d;->a()V

    .line 892
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/DrawerLayout$d;
    ...
    .line 899
    :pswitch_2
    invoke-virtual {p0, v6}, Landroid/support/v4/widget/DrawerLayout;->a(Z)V
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 1225
    invoke-static {p2}, Lav;->b(Landroid/view/KeyEvent;)V
...
.method protected onLayout(ZIIII)V
    ...
    iput-boolean v0, v1, Landroid/support/v4/widget/DrawerLayout;->k:Z
    ...
    .line 689
    .local v13, "lp":Landroid/support/v4/widget/DrawerLayout$c;
    move-object/from16 v0, p0
    ...
    .line 690
    iget v0, v13, Landroid/support/v4/widget/DrawerLayout$c;->leftMargin:I

    move/from16 v18, v0

    iget v0, v13, Landroid/support/v4/widget/DrawerLayout$c;->topMargin:I
    ...
    iget v0, v13, Landroid/support/v4/widget/DrawerLayout$c;->b:F
    ...
    :goto_3
    iget v0, v13, Landroid/support/v4/widget/DrawerLayout$c;->a:I
    ...
    .line 721
    .local v11, "height":I
    iget v0, v13, Landroid/support/v4/widget/DrawerLayout$c;->bottomMargin:I
    ...
    .line 735
    iget v9, v13, Landroid/support/v4/widget/DrawerLayout$c;->topMargin:I
    ...
    .end local v13    # "lp":Landroid/support/v4/widget/DrawerLayout$c;
    .end local v14    # "newOffset":F
    .end local v16    # "vgrav":I
    :cond_9
    const/16 v18, 0x0
    ...
    iput-boolean v0, v1, Landroid/support/v4/widget/DrawerLayout;->l:Z
...
.method protected onMeasure(II)V
    ...
    check-cast v14, Landroid/support/v4/widget/DrawerLayout$c;

    .line 645
    .local v14, "lp":Landroid/support/v4/widget/DrawerLayout$c;
    move-object/from16 v0, p0

    invoke-virtual {v0, v3}, Landroid/support/v4/widget/DrawerLayout;->f(Landroid/view/View;)Z
    ...
    .line 647
    iget v0, v14, Landroid/support/v4/widget/DrawerLayout$c;->leftMargin:I

    move/from16 v17, v0

    sub-int v17, v16, v17

    iget v0, v14, Landroid/support/v4/widget/DrawerLayout$c;->rightMargin:I
    ...
    iget v0, v14, Landroid/support/v4/widget/DrawerLayout$c;->topMargin:I

    move/from16 v17, v0

    sub-int v17, v12, v17

    iget v0, v14, Landroid/support/v4/widget/DrawerLayout$c;->bottomMargin:I
    ...
    invoke-virtual {v0, v3}, Landroid/support/v4/widget/DrawerLayout;->g(Landroid/view/View;)Z
    ...
    invoke-virtual {v0, v3}, Landroid/support/v4/widget/DrawerLayout;->e(Landroid/view/View;)I
    ...
    iget v0, v0, Landroid/support/v4/widget/DrawerLayout;->b:I
    ...
    iget v0, v14, Landroid/support/v4/widget/DrawerLayout$c;->width:I
    ...
    iget v0, v14, Landroid/support/v4/widget/DrawerLayout$c;->height:I
    ...
    .line 673
    .end local v3    # "child":Landroid/view/View;
    .end local v14    # "lp":Landroid/support/v4/widget/DrawerLayout$c;
    :cond_a
    return-void
.end method
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1248
    iget v2, v0, Landroid/support/v4/widget/DrawerLayout$SavedState;->a:I
    ...
    invoke-virtual {p0, v2}, Landroid/support/v4/widget/DrawerLayout;->a(I)Landroid/view/View;
    ...
    :cond_0
    iget v2, v0, Landroid/support/v4/widget/DrawerLayout$SavedState;->b:I
    ...
    .line 1256
    iget v2, v0, Landroid/support/v4/widget/DrawerLayout$SavedState;->c:I
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .line 1273
    .local v3, "lp":Landroid/support/v4/widget/DrawerLayout$c;
    iget-boolean v6, v3, Landroid/support/v4/widget/DrawerLayout$c;->d:Z

    if-eqz v6, :cond_0

    .line 1274
    iget v6, v3, Landroid/support/v4/widget/DrawerLayout$c;->a:I

    iput v6, v4, Landroid/support/v4/widget/DrawerLayout$SavedState;->a:I

    .line 1280
    .end local v0    # "child":Landroid/view/View;
    .end local v3    # "lp":Landroid/support/v4/widget/DrawerLayout$c;
    :cond_2
    iget v6, p0, Landroid/support/v4/widget/DrawerLayout;->m:I

    iput v6, v4, Landroid/support/v4/widget/DrawerLayout$SavedState;->b:I

    .line 1281
    iget v6, p0, Landroid/support/v4/widget/DrawerLayout;->n:I

    iput v6, v4, Landroid/support/v4/widget/DrawerLayout$SavedState;->c:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .prologue
    .line 910
    iget-object v10, p0, Landroid/support/v4/widget/DrawerLayout;->f:Lcc;

    invoke-virtual {v10, p1}, Lcc;->b(Landroid/view/MotionEvent;)V

    .line 911
    iget-object v10, p0, Landroid/support/v4/widget/DrawerLayout;->g:Lcc;
    ...
    .line 920
    .local v9, "y":F
    iput v8, p0, Landroid/support/v4/widget/DrawerLayout;->r:F

    .line 921
    iput v9, p0, Landroid/support/v4/widget/DrawerLayout;->s:F

    .line 922
    const/4 v10, 0x0

    iput-boolean v10, p0, Landroid/support/v4/widget/DrawerLayout;->o:Z

    .line 923
    const/4 v10, 0x0

    iput-boolean v10, p0, Landroid/support/v4/widget/DrawerLayout;->p:Z
    ...
    invoke-virtual {v10, v11, v12}, Lcc;->d(II)Landroid/view/View;
    ...
    .line 933
    iget v10, p0, Landroid/support/v4/widget/DrawerLayout;->r:F

    sub-float v1, v8, v10

    .line 934
    .local v1, "dx":F
    iget v10, p0, Landroid/support/v4/widget/DrawerLayout;->s:F
...
.method public setDrawerListener(Landroid/support/v4/widget/DrawerLayout$b;)V
    .locals 0
    .param p1, "listener"    # Landroid/support/v4/widget/DrawerLayout$b;
