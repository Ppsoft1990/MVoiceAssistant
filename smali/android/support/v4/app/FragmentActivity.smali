...
.field final mContainer:Lg;

.field mCreated:Z

.field public final mFragments:Li;

.field public final mHandler:Landroid/os/Handler;

.field mLoaderManager:Ll;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->mFragments:Li;
    ...
    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->mContainer:Lg;
...
.method public dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 683
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->mLoaderManager:Ll;
    ...
    invoke-virtual {v1, v2, p2, p3, p4}, Ll;->a(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V

    .line 689
    :cond_1
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->mFragments:Li;

    invoke-virtual {v1, p1, p2, p3, p4}, Li;->a(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method public getLastCustomNonConfigurationInstance()Ljava/lang/Object;
    ...
    iget-object v1, v0, Landroid/support/v4/app/FragmentActivity$b;->b:Ljava/lang/Object;
...
.method getLoaderManager(Ljava/lang/String;ZZ)Ll;
    .locals 2
    ...
    .prologue
    .line 885
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->mAllLoaderManagers:Lao;
    ...
    iput-object v1, p0, Landroid/support/v4/app/FragmentActivity;->mAllLoaderManagers:Lao;

    .line 888
    :cond_0
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->mAllLoaderManagers:Lao;

    invoke-virtual {v1, p1}, Lao;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .end local v0    # "lm":Ll;
    invoke-direct {v0, p1, p0, p2}, Ll;-><init>(Ljava/lang/String;Landroid/support/v4/app/FragmentActivity;Z)V

    .line 892
    .restart local v0    # "lm":Ll;
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->mAllLoaderManagers:Lao;

    invoke-virtual {v1, p1, v0}, Lao;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 895
    :cond_2
    invoke-virtual {v0, p0}, Ll;->a(Landroid/support/v4/app/FragmentActivity;)V

    goto :goto_0
.end method

.method public getSupportFragmentManager()Lh;
    .locals 1

    .prologue
    .line 827
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->mFragments:Li;

    return-object v0
.end method

.method public getSupportLoaderManager()Lk;
    .locals 3
    ...
    .line 876
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->mLoaderManager:Ll;
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroid/support/v4/app/FragmentActivity;->getLoaderManager(Ljava/lang/String;ZZ)Ll;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->mLoaderManager:Ll;
...
.method public invalidateSupportFragment(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, p1}, Lao;->remove(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    .prologue
    .line 152
    iget-object v2, p0, Landroid/support/v4/app/FragmentActivity;->mFragments:Li;

    invoke-virtual {v2}, Li;->i()V
    ...
    iget-object v2, v2, Li;->f:Ljava/util/ArrayList;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 198
    iget-object v3, p0, Landroid/support/v4/app/FragmentActivity;->mFragments:Li;

    iget-object v4, p0, Landroid/support/v4/app/FragmentActivity;->mContainer:Lg;

    invoke-virtual {v3, p0, v4, v2}, Li;->a(Landroid/support/v4/app/FragmentActivity;Lg;Landroid/support/v4/app/Fragment;)V
    ...
    .line 209
    iget-object v3, v0, Landroid/support/v4/app/FragmentActivity$b;->e:Lao;

    iput-object v3, p0, Landroid/support/v4/app/FragmentActivity;->mAllLoaderManagers:Lao;
    ...
    iget-object v2, v0, Landroid/support/v4/app/FragmentActivity$b;->d:Ljava/util/ArrayList;

    :cond_2
    invoke-virtual {v3, v1, v2}, Li;->a(Landroid/os/Parcelable;Ljava/util/ArrayList;)V
...
.method public onCreatePanelMenu(ILandroid/view/Menu;)Z
    ...
    invoke-virtual {v1, p2, v2}, Li;->a(Landroid/view/Menu;Landroid/view/MenuInflater;)Z
...
.method public onCreateView(Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    sget-object v7, Landroid/support/v4/app/FragmentActivity$a;->a:[I
    ...
    iget-object v7, p0, Landroid/support/v4/app/FragmentActivity;->mFragments:Li;

    invoke-virtual {v7, v4}, Li;->a(I)Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {v7, v6}, Li;->a(Ljava/lang/String;)Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {v7, v1}, Li;->a(I)Landroid/support/v4/app/Fragment;
    ...
    iput-object v7, v3, Landroid/support/v4/app/Fragment;->mFragmentManager:Li;
    ...
    invoke-virtual {v7, v3, v10}, Li;->a(Landroid/support/v4/app/Fragment;Z)V
    ...
    invoke-virtual {v7, v3}, Li;->b(Landroid/support/v4/app/Fragment;)V
...
.method public onMenuItemSelected(ILandroid/view/MenuItem;)Z
    ...
    invoke-virtual {v0, p2}, Li;->a(Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {v0, p2}, Li;->b(Landroid/view/MenuItem;)Z
...
.method public onPanelClosed(ILandroid/view/Menu;)V
    ...
    invoke-virtual {v0, p2}, Li;->b(Landroid/view/Menu;)V
...
.method public onPreparePanel(ILandroid/view/View;Landroid/view/Menu;)Z
    ...
    invoke-virtual {v1, p3}, Li;->a(Landroid/view/Menu;)Z
...
.method public final onRetainNonConfigurationInstance()Ljava/lang/Object;
    ...
    iget-object v8, p0, Landroid/support/v4/app/FragmentActivity;->mFragments:Li;

    invoke-virtual {v8}, Li;->g()Ljava/util/ArrayList;
    ...
    iget-object v8, p0, Landroid/support/v4/app/FragmentActivity;->mAllLoaderManagers:Lao;
    ...
    invoke-virtual {v8, v3}, Lao;->c(I)Ljava/lang/Object;
    ...
    .line 522
    :cond_2
    invoke-virtual {v4}, Ll;->h()V

    .line 523
    iget-object v8, p0, Landroid/support/v4/app/FragmentActivity;->mAllLoaderManagers:Lao;

    iget-object v10, v4, Ll;->d:Ljava/lang/String;

    invoke-virtual {v8, v10}, Lao;->remove(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 531
    :cond_4
    new-instance v6, Landroid/support/v4/app/FragmentActivity$b;

    invoke-direct {v6}, Landroid/support/v4/app/FragmentActivity$b;-><init>()V

    .line 532
    .local v6, "nci":Landroid/support/v4/app/FragmentActivity$b;
    iput-object v9, v6, Landroid/support/v4/app/FragmentActivity$b;->a:Ljava/lang/Object;

    .line 533
    iput-object v1, v6, Landroid/support/v4/app/FragmentActivity$b;->b:Ljava/lang/Object;

    .line 534
    iput-object v9, v6, Landroid/support/v4/app/FragmentActivity$b;->c:Lao;

    .line 535
    iput-object v2, v6, Landroid/support/v4/app/FragmentActivity$b;->d:Ljava/util/ArrayList;

    .line 536
    iget-object v8, p0, Landroid/support/v4/app/FragmentActivity;->mAllLoaderManagers:Lao;

    iput-object v8, v6, Landroid/support/v4/app/FragmentActivity$b;->e:Lao;
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v1}, Li;->h()Landroid/os/Parcelable;
...
.method public onStart()V
    ...
    .line 566
    iget-object v4, p0, Landroid/support/v4/app/FragmentActivity;->mFragments:Li;

    invoke-virtual {v4}, Li;->k()V

    .line 569
    :cond_0
    iget-object v4, p0, Landroid/support/v4/app/FragmentActivity;->mFragments:Li;

    invoke-virtual {v4}, Li;->i()V

    .line 570
    iget-object v4, p0, Landroid/support/v4/app/FragmentActivity;->mFragments:Li;

    invoke-virtual {v4}, Li;->e()Z
    ...
    .line 574
    iget-object v4, p0, Landroid/support/v4/app/FragmentActivity;->mLoaderManager:Ll;
    ...
    invoke-virtual {v4}, Li;->l()V

    .line 588
    iget-object v4, p0, Landroid/support/v4/app/FragmentActivity;->mAllLoaderManagers:Lao;
    ...
    invoke-virtual {v4, v1}, Lao;->c(I)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v4, v5, v7}, Landroid/support/v4/app/FragmentActivity;->getLoaderManager(Ljava/lang/String;ZZ)Ll;

    move-result-object v4

    iput-object v4, p0, Landroid/support/v4/app/FragmentActivity;->mLoaderManager:Ll;
    ...
    .line 596
    .local v2, "lm":Ll;
    invoke-virtual {v2}, Ll;->e()V

    .line 597
    invoke-virtual {v2}, Ll;->g()V
...
.method public supportInvalidateOptionsMenu()V
    ...
    .line 648
    invoke-static {p0}, Ld;->a(Landroid/app/Activity;)V
