...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v7, p0, Landroid/support/v4/view/PagerTitleStrip;->g:F
    ...
    invoke-direct {v7, p0, v8}, Landroid/support/v4/view/PagerTitleStrip$a;-><init>(Landroid/support/v4/view/PagerTitleStrip;Landroid/support/v4/view/PagerTitleStrip$1;)V
    ...
    iput v7, p0, Landroid/support/v4/view/PagerTitleStrip;->e:I
...
.method a(IFZ)V
    ...
    iget v0, v0, Landroid/support/v4/view/PagerTitleStrip;->f:I
    ...
    invoke-virtual/range {v42 .. v42}, Landroid/support/v4/view/ViewPager;->getAdapter()Lba;
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v4/view/PagerTitleStrip;->a(ILba;)V
    ...
    iget v0, v0, Landroid/support/v4/view/PagerTitleStrip;->g:F
...
.method a(ILba;)V
    ...
    invoke-virtual {p2}, Lba;->getCount()I
    ...
    :goto_0
    iput-boolean v7, p0, Landroid/support/v4/view/PagerTitleStrip;->j:Z
    ...
    invoke-virtual {p2, v7}, Lba;->getPageTitle(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p2, p1}, Lba;->getPageTitle(I)Ljava/lang/CharSequence;
    ...
    .line 301
    iget-boolean v7, p0, Landroid/support/v4/view/PagerTitleStrip;->k:Z

    if-nez v7, :cond_2

    .line 302
    iget v7, p0, Landroid/support/v4/view/PagerTitleStrip;->g:F

    invoke-virtual {p0, p1, v7, v6}, Landroid/support/v4/view/PagerTitleStrip;->a(IFZ)V

    .line 305
    :cond_2
    iput-boolean v6, p0, Landroid/support/v4/view/PagerTitleStrip;->j:Z
...
.method a(Lba;Lba;)V
    .locals 1
    .param p1, "oldAdapter"    # Lba;
    .param p2, "newAdapter"    # Lba;
    ...
    invoke-virtual {p1, v0}, Lba;->unregisterDataSetObserver(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {p2, v0}, Lba;->registerDataSetObserver(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {p0, v0, p2}, Landroid/support/v4/view/PagerTitleStrip;->a(ILba;)V
...
.method protected onAttachedToWindow()V
    ...
    invoke-virtual {v1}, Landroid/support/v4/view/ViewPager;->getAdapter()Lba;

    move-result-object v0

    .line 253
    .local v0, "adapter":Lba;
    ...
    invoke-virtual {v1, v3}, Landroid/support/v4/view/ViewPager;->setOnAdapterChangeListener(Landroid/support/v4/view/ViewPager$e;)V
    ...
    :goto_0
    invoke-virtual {p0, v3, v0}, Landroid/support/v4/view/PagerTitleStrip;->a(Lba;Lba;)V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/view/ViewPager;->getAdapter()Lba;

    move-result-object v0

    invoke-virtual {p0, v0, v1}, Landroid/support/v4/view/PagerTitleStrip;->a(Lba;Lba;)V
...
.method protected onMeasure(II)V
    ...
    .line 441
    .local v1, "childHeightSpec":I
    iget-object v10, p0, Landroid/support/v4/view/PagerTitleStrip;->b:Landroid/widget/TextView;
    ...
    .line 443
    iget-object v10, p0, Landroid/support/v4/view/PagerTitleStrip;->d:Landroid/widget/TextView;
...
.method public setNonPrimaryAlpha(F)V
    ...
    iget v2, p0, Landroid/support/v4/view/PagerTitleStrip;->e:I
