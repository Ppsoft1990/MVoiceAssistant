.class public Lcom/iflytek/common/adaptation/mms/M823MmsAdapter;
.super Lcom/iflytek/common/adaptation/mms/DefaultMmsAdapter;
.source "M823MmsAdapter.java"


# static fields
.field private static final TAG:Ljava/lang/String; = "M823MmsAdapter"
...
.method private initSmsManager(I)Landroid/telephony/SmsManager;
    ...
    .line 101
    const-string/jumbo v9, "M823MmsAdapter"
...
.method public getSimCardMmsNotice(Landroid/content/Intent;)Lcom/iflytek/common/adaptation/entity/SimCard;
    ...
    :try_start_1
    const-string/jumbo v7, "android.telephony.SmsMessage"
    ...
    invoke-static {v0, v7, v10}, Lcom/iflytek/common/adaptation/util/BeanUtils;->getDeclaredMethod(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    ...
    .restart local v8    # "subscription":J
    :cond_0
    sget-object v1, Lcom/iflytek/common/adaptation/entity/SimCard;->first:Lcom/iflytek/common/adaptation/entity/SimCard;
    :try_end_1
    ...
    :try_start_2
    const-string/jumbo v7, "M823MmsAdapter"

    const-string/jumbo v10, "SmsMessage refect error"
    ...
    const-string/jumbo v10, "SmsMessage[] is null or empty"
    ...
    const-string/jumbo v11, "getSimCardMmsNotice error "

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    invoke-virtual {v3}, Lcom/iflytek/common/adaptation/exception/SmsParserException;->getMessage()Ljava/lang/String;
...
.method protected sendBinaryMessage(Lcom/iflytek/common/adaptation/entity/SimCard;Ljava/lang/String;Ljava/lang/String;[B)V
    ...
    .local v9, "simId":I
    :cond_0
    const-string/jumbo v1, "M823MmsAdapter"
    ...
    .line 70
    invoke-direct {p0, v9}, Lcom/iflytek/common/adaptation/mms/M823MmsAdapter;->initSmsManager(I)Landroid/telephony/SmsManager;
    ...
    iget-object v3, p0, Lcom/iflytek/common/adaptation/mms/M823MmsAdapter;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p0, v8, v1, v2, p2}, Lcom/iflytek/common/adaptation/mms/M823MmsAdapter;->intentPutPhoneExtra(Landroid/content/Intent;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/String;)V

    .line 80
    iget-object v1, p0, Lcom/iflytek/common/adaptation/mms/M823MmsAdapter;->mContext:Landroid/content/Context;
...
.method public sendTextMessage(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;JJI)V
    ...
    .prologue
    .line 34
    const-string/jumbo v2, "M823MmsAdapter"
    ...
    invoke-direct {p0, v0}, Lcom/iflytek/common/adaptation/mms/M823MmsAdapter;->initSmsManager(I)Landroid/telephony/SmsManager;
    ...
    invoke-virtual {p0, v8, v2, v3, p1}, Lcom/iflytek/common/adaptation/mms/M823MmsAdapter;->intentPutPhoneExtra(Landroid/content/Intent;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/String;)V

    .line 54
    iget-object v2, p0, Lcom/iflytek/common/adaptation/mms/M823MmsAdapter;->mContext:Landroid/content/Context;
