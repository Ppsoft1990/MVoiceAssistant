...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lbia;->d:Lbhc;

    sput-object v1, Lbia;->e:Lbia;

    sput-object v1, Lbia;->f:Landroid/content/Context;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lbia;->a:Lorg/apache/http/impl/client/DefaultHttpClient;

    iput-object v0, p0, Lbia;->b:Lbhh;
    ...
    iput-object v0, p0, Lbia;->c:Ljava/lang/StringBuilder;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lbia;->g:J
    ...
    sput-object v0, Lbia;->f:Landroid/content/Context;
    ...
    iput-object v1, p0, Lbia;->a:Lorg/apache/http/impl/client/DefaultHttpClient;

    iget-object v0, p0, Lbia;->a:Lorg/apache/http/impl/client/DefaultHttpClient;

    new-instance v1, Lbib;

    invoke-direct {v1, p0}, Lbib;-><init>(Lbia;)V
...
.method static a()Landroid/content/Context;
    ...
    sget-object v0, Lbia;->f:Landroid/content/Context;
...
.method private a(Lorg/json/JSONObject;)V
    ...
    :cond_0
    sget-object v1, Lbia;->f:Landroid/content/Context;

    invoke-static {v1}, Lbfn;->a(Landroid/content/Context;)Lbfn;

    move-result-object v1

    invoke-virtual {v1, v0}, Lbfn;->a(Ljava/lang/String;)V
    ...
    invoke-static {v1, v0}, Lbfq;->a(Landroid/content/Context;Lorg/json/JSONObject;)V
    ...
    invoke-static {v0}, Lbhn;->z(Landroid/content/Context;)V

    sget-object v0, Lbia;->f:Landroid/content/Context;

    invoke-static {v0, v1}, Lbhn;->a(Landroid/content/Context;I)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method static b(Landroid/content/Context;)Lbia;
    .locals 2
    ...
    invoke-direct {v0, p0}, Lbia;-><init>(Landroid/content/Context;)V
...
.method a(Lbfy;Lbhz;)V
    ...
    invoke-virtual {p0, v0, p2}, Lbia;->b(Ljava/util/List;Lbhz;)V

    return-void
.end method

.method a(Ljava/util/List;Lbhz;)V
    .locals 12
    ...
    :try_start_0
    iget-object v0, p0, Lbia;->c:Ljava/lang/StringBuilder;

    const/4 v4, 0x0

    iget-object v5, p0, Lbia;->c:Ljava/lang/StringBuilder;
    ...
    invoke-static {}, Lbfq;->n()Ljava/lang/String;
    ...
    sget-object v5, Lbia;->f:Landroid/content/Context;

    invoke-static {v5}, Lbfu;->a(Landroid/content/Context;)Lbfu;

    move-result-object v5

    invoke-virtual {v5}, Lbfu;->a()Lorg/apache/http/HttpHost;
    ...
    iget-object v7, p0, Lbia;->a:Lorg/apache/http/impl/client/DefaultHttpClient;
    ...
    invoke-virtual {v6, v8}, Lbhc;->b(Ljava/lang/Object;)V
    ...
    invoke-virtual {v2, v3}, Lbhc;->f(Ljava/lang/Object;)V

    if-eqz p2, :cond_9

    invoke-interface {p2}, Lbhz;->b()V
    ...
    iput-object v1, p0, Lbia;->c:Ljava/lang/StringBuilder;
    ...
    invoke-virtual {v7, v8}, Lbhc;->h(Ljava/lang/Object;)V
    ...
    sget-object v8, Lbfq;->l:Ljava/lang/String;
    ...
    invoke-static {v0}, Lbhn;->a([B)[B

    move-result-object v0

    invoke-static {v0}, Lbhi;->b([B)[B
    ...
    invoke-virtual {v5, v6}, Lbhc;->b(Ljava/lang/Object;)V
    ...
    invoke-direct {p0, v5}, Lbia;->a(Lorg/json/JSONObject;)V
    ...
    invoke-virtual {v2, v0}, Lbhc;->e(Ljava/lang/Object;)V
...
.method b(Ljava/util/List;Lbhz;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, p1, p2}, Lbic;-><init>(Lbia;Ljava/util/List;Lbhz;)V
