...
# static fields
.field private static synthetic $SWITCH_TABLE$de$greenrobot$event$ThreadMode:[I = null
...
.method private postSingleEvent(Ljava/lang/Object;Lde/greenrobot/event/EventBus$PostingThreadState;)V
    ...
    const-string/jumbo v11, "No subscribers registered for event "
...
.method private subscribe(Ljava/lang/Object;Lde/greenrobot/event/SubscriberMethod;ZI)V
    ...
    const-string/jumbo v10, "Subscriber "
    ...
    const-string/jumbo v10, " already registered to event "
...
.method public cancelEventDelivery(Ljava/lang/Object;)V
    ...
    .line 384
    const-string/jumbo v2, "This method may only be called from inside event handling methods on the posting thread"
    ...
    const-string/jumbo v2, "Only the currently handled event may be aborted"
    ...
    const-string/jumbo v2, " event handlers may only abort the incoming event"
