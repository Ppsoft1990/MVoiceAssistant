...
.method public static attachTo(Landroid/app/Activity;Ljava/lang/Object;ZLandroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/FragmentActivity;->getSupportFragmentManager()Lh;
    ...
    invoke-virtual {v0, v2}, Lh;->a(Ljava/lang/String;)Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {v2, v1, v3}, Lj;->a(Landroid/support/v4/app/Fragment;Ljava/lang/String;)Lj;
...
.method public onEventMainThread(Lde/greenrobot/event/util/ThrowableFailureEvent;)V
    ...
    .line 70
    invoke-virtual {p0}, Lde/greenrobot/event/util/ErrorDialogManager$SupportManagerFragment;->getFragmentManager()Lh;

    move-result-object v2

    .line 71
    .local v2, "fm":Lh;
    invoke-virtual {v2}, Lh;->b()Z

    .line 73
    const-string/jumbo v3, "de.greenrobot.eventbus.error_dialog"

    invoke-virtual {v2, v3}, Lh;->a(Ljava/lang/String;)Landroid/support/v4/app/Fragment;
    ...
    .line 74
    .local v1, "existingFragment":Lf;
    if-eqz v1, :cond_2

    .line 76
    invoke-virtual {v1}, Lf;->dismiss()V
    ...
    .line 81
    .local v0, "errorFragment":Lf;
    if-eqz v0, :cond_0

    .line 82
    const-string/jumbo v3, "de.greenrobot.eventbus.error_dialog"

    invoke-virtual {v0, v2, v3}, Lf;->show(Lh;Ljava/lang/String;)V
